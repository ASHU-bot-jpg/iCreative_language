          ...
          <div className="hidden lg:flex items-center space-x-8">
            <Link
              ...
              className={`px-3 py-2 text-xl font-normal ${
                isActive("/") ? "text-icreative-purple" : "text-black hover:text-icreative-purple"
              }`}
            >
              Home
            </Link>
            <Link
              to="/programs"
              className={`px-3 py-2 text-xl font-normal ${
                isActive("/programs") ? "text-icreative-purple" : "text-black hover:text-icreative-purple"
              }`}
            >
              Programs
            </Link>
            <Link
              to="/about"
              className={`px-3 py-2 text-xl font-normal ${
                isActive("/about") ? "text-icreative-purple" : "text-black hover:text-icreative-purple"
              }`}
            >
              About
            </Link>
