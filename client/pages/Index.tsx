      ...
      <section className="max-w-7xl mx-auto px-4 lg:px-20 py-4 sm:py-8 pt-16">
        <div className="grid lg:grid-cols-2 gap-6 sm:gap-8 items-center">
          ...
          <div className="space-y-4 sm:space-y-6 text-center lg:text-left">
            <h1 className="text-xl sm:text-2xl lg:text-3xl xl:text-4xl font-bold text-icreative-purple font-roboto leading-normal pt-10 mb-2.5">
          ...
          <div className="flex justify-center lg:justify-end order-first lg:order-last">
            <div className="relative">
              <img
                src="https://cdn.builder.io/api/v1/image/assets%2F4dea029619d64c5c95c3070ae0fffe0b%2Fc1ade894307660928596a906407fdae8a8f7109f"
                alt="Smiley kids in the main plan"
                className="w-full max-w-3xl h-72 sm:h-80 object-cover rounded-3xl shadow-lg"
              />
            </div>
          </div>
        </div>
