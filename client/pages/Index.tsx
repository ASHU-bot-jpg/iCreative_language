      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 lg:px-20">
          ...
          <div className="text-center">
            ...
            >
              Browse more
              <svg className="ml-2 w-4 h-4" fill="currentColor" viewBox="0 0 8 12">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-8">
            ...
            <div className="bg-white/0 text-center p-6 space-y-4">
              <div className="w-16 h-16 bg-icreative-pink rounded-full flex items-center justify-center mx-auto">
                <svg className="w-6 h-6 text-icreative-magenta" fill="currentColor" viewBox="0 0 24 25">
              ...
              <h3 className="text-lg font-bold text-black">Focus on Cognitive Development</h3>
            ...
            <div className="bg-white/0 text-center p-6 space-y-4">
              ...
              <h3 className="text-lg font-bold text-black">Advanced Curriculum that Inspires</h3>
              <p className="text-sm text-gray-600">
            ...
            <div className="bg-white/0 text-center p-6 space-y-4">
              <div className="w-16 h-16 bg-icreative-pink rounded-full flex items-center justify-center mx-auto">
                <svg className="w-6 h-6 text-icreative-magenta" fill="currentColor" viewBox="0 0 20 21">
              ...
              <h3 className="text-lg font-bold text-black">Smart Fun That Sticks</h3>
              <p className="text-sm text-gray-600">
                By combining academic advancement with cognitive training and creativity, our students learn more, retain more, and enjoy the process.
              </p>
            </div>
            ...
            <div className="bg-white/0 text-center p-6 space-y-4">
              ...
              <h3 className="text-lg font-bold text-black">Designed for Real Results</h3>
              <p className="text-sm text-gray-600">
            ...
            <div className="bg-white/0 text-center p-6 space-y-4">
              ...
              <h3 className="text-lg font-bold text-black">Experienced, Caring Educators</h3>
              <p className="text-sm text-gray-600">
                Our teachers are passionate about making a difference and use gentle, encouraging methods.
              </p>
            </div>
            ...
            <div className="bg-white/0 text-center p-6 space-y-4">
              <div className="w-16 h-16 bg-icreative-pink rounded-full flex items-center justify-center mx-auto">
                <svg className="w-6 h-6 text-icreative-magenta" fill="currentColor" viewBox="0 0 22 17">
              ...
              <h3 className="text-lg font-bold text-black">Personalized Small Group Classes</h3>
              <p className="text-sm text-gray-600">
                We keep our class sizes small to give every child the attention they deserve.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 lg:px-20">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white border border-purple-200 rounded-2xl p-6 shadow-lg border-t-4 border-t-purple-400">
              <p className="text-xs text-black mb-4 text-justify leading-relaxed">
                Iraa is having fun learning in her class. Teachers are very nice and supportive. I can see improvement in her academics. Thank you ICreative Learning.
              </p>
              <div className="mt-4">
